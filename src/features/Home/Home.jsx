...
import logo from "../../assets/images/zohaib-insights-logos/logo-transparent.png";
      ...
      >
        ...
        <div className="my-auto" id="home_left_section_container">
          <div className="mb-6">
            ...
            <p>Experienced in NLP, Computer Vision, Data Science</p>
          </div>
